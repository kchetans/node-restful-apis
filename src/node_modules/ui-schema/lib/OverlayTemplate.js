...
class OverlayTemplate extends BaseContainer {

    static init(param) {
        return new OverlayTemplate(param);
    }

    constructor(param) {
        super(param);
        this.config = {'type': WxComponents.OVERLAY_TEMPLATE};
    }
...
module.exports = OverlayTemplate;
